...
var mqttMSG = false;
var debug = require('debug')('Aussenbereich');

var name = "Schuppen"; //accessory name
var sonoffUUID = "hap-nodejs:accessories:sonoff:schuppen"; //change this to your preferences
var sonoffUsername = "AA:BB:CC:DD:EE:01";;
...
client.on('connect', function () {
  client.subscribe('stat/'+MQTT_NAME+'/POWER1', 4);
});
